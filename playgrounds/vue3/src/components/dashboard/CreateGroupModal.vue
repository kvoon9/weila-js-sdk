    ...
    <div v-if="visible" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50"
      ...
      <div class="bg-white rounded-lg shadow-xl w-full max-w-md mx-4 overflow-hidden">
        ...
        <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
          <h2 class="text-lg font-semibold text-gray-900">创建群组</h2>
          <button @click="handleClose" class="p-1 rounded hover:bg-gray-100 text-gray-500">
        ...
        <div class="p-6 space-y-4">
          <!-- Group Name -->
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1.5">群组名称</label>
          ...
          <!-- Public Type -->
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1.5">群组类型</label>
