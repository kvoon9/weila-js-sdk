var opus_module = (function () {
  ...
  return function (opus_module) {
    ...
    /** @type {function(...*):?} */
    var _Opus_destroyDecoder = (Module['_Opus_destroyDecoder'] =
      createExportWrapper('Opus_destroyDecoder'))

    /** @type {function(...*):?} */
    var _Opus_destroyEncoder = (Module['_Opus_destroyEncoder'] =
      createExportWrapper('Opus_destroyEncoder'))
