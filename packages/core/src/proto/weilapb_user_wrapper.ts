...
class WeilaPbUserWrapper {
  public static buildGetUserInfoReq(key: string): WLBuildMsgRet {
    ...
    return BuildWeilaMsg.buildWeilaMsgReq(
      ...
      WL.User.UserCommandId.USER_COMMAND_GET_USERINFO,
  ...
  public static buildChangeUserInfoReq(changeUserInfo: WLChangeUserInfoData): WLBuildMsgRet {
    ...
    return BuildWeilaMsg.buildWeilaMsgReq(
      WL.Service.ServiceID.SERVICE_USER,
      WL.User.UserCommandId.USER_COMMAND_CHANGE_USERINFO,
      WL.Service.CommandType.COMMAND_REQUEST,
      userMessage,
    );
  }
  ...
  public static buildGetConfigReq(): WLBuildMsgRet {
    ...
    return BuildWeilaMsg.buildWeilaMsgReq(
      WL.Service.ServiceID.SERVICE_USER,
      WL.User.UserCommandId.USER_COMMAND_GET_CONFIG,
      WL.Service.CommandType.COMMAND_REQUEST,
      userMessage,
    );
  }

  public static buildSetConfigReq(
    userId: number,
    key: string,
    value: string,
    subUserId: number,
    ...
    return BuildWeilaMsg.buildWeilaMsgReq(
      WL.Service.ServiceID.SERVICE_USER,
      WL.User.UserCommandId.USER_COMMAND_SET_CONFIG,
      WL.Service.CommandType.COMMAND_REQUEST,
      userMessage,
      subUserId,
    );
