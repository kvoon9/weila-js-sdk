...
export {
    WL_IDbSettingID, WL_IDbSetting,
    WL_IDbSessionStatus, WL_IDbSession, WL_IDbSessionType, WL_IDbSessionSetting,
    WL_IDbUserInfo,WL_IDbSessionSettingParams,
    WL_IDbGroupType, WL_IDbGroupPublicType, WL_IDbGroupAuthType, WL_IDbMemberType,
    WL_IDbGroup, WL_IDbMemberStatus, WL_IDbMemberInfo, WL_IDbGroupMember,
    WL_IDbFriendStatus, WL_IDbFriendInfo, WL_IDbFriend,
    WL_IDbMsgDataType, WL_IDbMsgDataStatus, WL_IDbAudioData,
    WL_IDbFileData, WL_IDbLocationShared, WL_IDbPttData, WL_IDbMsgData,
    WL_IDbLocationInfo, WL_IDbNotificationType, WL_IDbNotification,
    WL_IDbExtension, WL_IDbExtensionInfo, WL_IDbExtensionState,
    WL_IDbService, WL_IDbServiceStaff, WL_IDbServiceSession, WL_ServiceStatus,
    WL_IDbServiceStaffInfo, WL_IDbServiceSessionInfo, WL_IDbExtensionType
};
