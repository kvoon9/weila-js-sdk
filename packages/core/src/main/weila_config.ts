...
const configItemInfo = [
    {id: WL_ConfigID.WL_RES_RING_START_PLAY_ID, url: start_play_wav, dataType: 'data_url', version: 1},
    {id: WL_ConfigID.WL_RES_RING_STOP_PLAY_ID, url: stop_play_wav, dataType: 'data_url', version: 1},
    {id: WL_ConfigID.WL_RES_RING_START_RECORD_ID, url: start_record_wav, dataType: 'data_url', version: 1},
    {id: WL_ConfigID.WL_RES_RING_STOP_RECORD_ID, url: stop_record_wav, dataType: 'data_url', version: 1},
