...
### Testing
**No test framework configured.** The `npm test` script is a placeholder that exits with error.
...
### Post-Install Hook
- `post-copy.js` script runs after `npm install`
- Copies public assets to distribution directory
...
- [ ] Development build succeeds (`npm run "build development"`)
