import {WL_NetworkEvent, WL_NetworkEventID, WL_NetworkState, WL_PbMsgData} from 'main/weila_internal_data';
                ...
                while (this.currentRecv >= WeilaMsgHeader.msgHeaderLen) {
                    ...
                    if (weilaHeader) {
                        ...
                        if (this.currentRecv >= headerValue.length) {
                            ...
                            wlMsgData.pbMsgData = this.recvBuffer.slice(WeilaMsgHeader.msgHeaderLen, headerValue.length);
