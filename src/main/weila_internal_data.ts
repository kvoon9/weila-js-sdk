...
const default_user_logo = "https://weilaavatar.oss-cn-shenzhen.aliyuncs.com/default/user_avatar_default.png";
...
export {
    WL_PromiseCallback, default_user_logo, default_group_logo, WL_PbMsgHandler, WL_CoreInterface,
    WL_NetworkEvent, WL_NetworkEventID, WL_NetworkState, WL_PbMsgData, WL_LoginParam, WL_LoginResult,
    WL_PttAudioItem, WL_PttPayload, WL_PttPacket, WL_PttFsmListener, WL_PttPackType
}
