...
class WeilaPBGroupWrapper {
    public static buildGetGroupVersionReq(): WLBuildMsgRet {
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_GROUP, WL.Group.GroupCommandId.GROUP_COMMAND_GET_GROUPVERSION,
    ...
    public static buildGetGroupAttributeReq(groupId: Long): WLBuildMsgRet {
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_GROUP, WL.Group.GroupCommandId.GROUP_COMMAND_GET_GROUPATTRIBUTE,
            WL.Service.CommandType.COMMAND_REQUEST, groupMessage);
    }

    public static buildCreateGroupReq(
        groupName: string, groupType: number, avatar: string,
        groupClass: number, publicType: number, memberIdList: number[]): WLBuildMsgRet {
        const groupMessage = new WL.Group.GroupMessage();
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_GROUP, WL.Group.GroupCommandId.GROUP_COMMAND_CREATE_GROUP,
            WL.Service.CommandType.COMMAND_REQUEST, groupMessage);
    }
    ...
    public static buildChangeGroupAttributeReq(groupAttribute: WLGroupAttributeInfo): WLBuildMsgRet {
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_GROUP, WL.Group.GroupCommandId.GROUP_COMMAND_CHANGE_GROUPATTRIBUTE,
            WL.Service.CommandType.COMMAND_REQUEST, groupMessage);
    }
    ...
    public static buildGetGroupInfoReq(groupId: Long, memberVer: number): WLBuildMsgRet {
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_GROUP, WL.Group.GroupCommandId.GROUP_COMMAND_GET_GROUPINFO,
            WL.Service.CommandType.COMMAND_REQUEST, groupMessage);
    }
    ...
    public static buildGetGroupOnlineMemberReq(groupId: Long): WLBuildMsgRet {
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_GROUP, WL.Group.GroupCommandId.GROUP_COMMAND_GET_ONLINE_MEMBER,
            WL.Service.CommandType.COMMAND_REQUEST, groupMessage);
    }

    public static buildChangeGroupMemberInfoReq(groupId: Long, memberInfo: WLGroupMemberInfo): WLBuildMsgRet {
        const groupMessage = new WL.Group.GroupMessage();
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_GROUP, WL.Group.GroupCommandId.GROUP_COMMAND_CHANGE_MEMBERINFO,
            WL.Service.CommandType.COMMAND_REQUEST, groupMessage);
    }
    ...
    public static buildGetGroupMemberInfoReq(groupId: Long, userIdList: number[]): WLBuildMsgRet {
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_GROUP, WL.Group.GroupCommandId.GROUP_COMMAND_GET_MEMBER_USERINFO,
            WL.Service.CommandType.COMMAND_REQUEST, groupMessage);
    }

    public static buildDelGroupMemebrReq(groupId: Long, userIdList: number[], subUserId?: number): WLBuildMsgRet {
        const groupMessage = new WL.Group.GroupMessage();
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_GROUP, WL.Group.GroupCommandId.GROUP_COMMAND_DELETE_MEMBER,
            WL.Service.CommandType.COMMAND_REQUEST, groupMessage, subUserId);
    }
    ...
    public static buildDelGroupReq(groupId: Long): WLBuildMsgRet {
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_GROUP, WL.Group.GroupCommandId.GROUP_COMMAND_DELETE_GROUP,
            WL.Service.CommandType.COMMAND_REQUEST, groupMessage);
    }
    ...
    public static buildGetGroupInvitationReq(lastUpdateTime: Long): WLBuildMsgRet {
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_GROUP, WL.Group.GroupCommandId.GROUP_COMMAND_GET_GROUP_INVITEINFO,
            WL.Service.CommandType.COMMAND_REQUEST, groupMessage);
    }
    ...
    public static buildGroupInviteReq(groupId: Long, userIdList: number[]): WLBuildMsgRet {
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_GROUP, WL.Group.GroupCommandId.GROUP_COMMAND_GROUP_INVITE,
            WL.Service.CommandType.COMMAND_REQUEST, groupMessage);
    }

    public static buildGroupAnswerInviteReq(groupId: Long, invitorId: number, status: number): WLBuildMsgRet {
        const groupMessage = new WL.Group.GroupMessage();
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_GROUP, WL.Group.GroupCommandId.GROUP_COMMAND_ANSWER_GROUP_INVITE,
            WL.Service.CommandType.COMMAND_REQUEST, groupMessage);
    }
    ...
    public static buildGroupGetJoinInfoReq(lasteUpdate: Long, groupIdList: Long[]): WLBuildMsgRet {
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_GROUP, WL.Group.GroupCommandId.GROUP_COMMAND_GET_GROUP_JOININFO,
            WL.Service.CommandType.COMMAND_REQUEST, groupMessage);
    }

    public static buildGroupJoinReq(groupId: Long, detail?: string, password?: string, subUserId?: number): WLBuildMsgRet {
        const groupMessage = new WL.Group.GroupMessage();
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_GROUP, WL.Group.GroupCommandId.GROUP_COMMAND_GROUP_JOIN,
            WL.Service.CommandType.COMMAND_REQUEST, groupMessage, subUserId);
    }

    public static buildGroupAnswerJoinReq(groupId: Long, joinId: number, status: number): WLBuildMsgRet {
        const groupMessage = new WL.Group.GroupMessage();
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_GROUP, WL.Group.GroupCommandId.GROUP_COMMAND_ANSWER_GROUP_JOIN,
            WL.Service.CommandType.COMMAND_REQUEST, groupMessage);
    }
    ...
    public static buildGroupBroadcastReq(groupId: Long, status: number): WLBuildMsgRet {
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_GROUP, WL.Group.GroupCommandId.GROUP_COMMAND_BROADCAST,
            WL.Service.CommandType.COMMAND_REQUEST, groupMessage);
    }

    public static buildGroupGetBlacklistReq(groupId: Long, pageIndex: number, pageCount: number): WLBuildMsgRet {
        const groupMessage = new WL.Group.GroupMessage();
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_GROUP, WL.Group.GroupCommandId.GROUP_COMMAND_GET_BLACKLIST,
            WL.Service.CommandType.COMMAND_REQUEST, groupMessage);
    }

    public static buildGroupChangeBlacklistReq(groupId: Long, userIdList: number[], actionType: number): WLBuildMsgRet {
        const groupMessage = new WL.Group.GroupMessage();
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_GROUP, WL.Group.GroupCommandId.GROUP_COMMAND_CHANGE_BLACKLIST,
            WL.Service.CommandType.COMMAND_REQUEST, groupMessage);
    }
    ...
    public static buildGetGroupMemberChangeLogReq(groupId: Long): WLBuildMsgRet {
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_GROUP, WL.Group.GroupCommandId.GROUP_COMMAND_GET_MEMBER_CHANGE_LOG,
            WL.Service.CommandType.COMMAND_REQUEST, groupMessage);
    }
    ...
    public static buildGetGroupNoticeReq(groupId: Long, latestUpdated: Long): WLBuildMsgRet {
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_GROUP, WL.Group.GroupCommandId.GROUP_COMMAND_GET_NOTICE,
            WL.Service.CommandType.COMMAND_REQUEST, groupMessage);
    }
    ...
    public static buildAddGroupNoticeReq(groupId: Long, notice: string): WLBuildMsgRet {
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_GROUP, WL.Group.GroupCommandId.GROUP_COMMAND_ADD_NOTICE,
            WL.Service.CommandType.COMMAND_REQUEST, groupMessage);
    }

    public static buildChangeGroupNoticeReq(groupId: Long, noticeId: Long, notice: string): WLBuildMsgRet {
        const groupMessage = new WL.Group.GroupMessage();
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_GROUP, WL.Group.GroupCommandId.GROUP_COMMAND_CHANGE_NOTICE,
            WL.Service.CommandType.COMMAND_REQUEST, groupMessage);
    }
    ...
    public static buildDeleteGroupNoticeReq(groupId: Long, noticeId: Long): WLBuildMsgRet {
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_GROUP, WL.Group.GroupCommandId.GROUP_COMMAND_DELETE_NOTICE,
            WL.Service.CommandType.COMMAND_REQUEST, groupMessage);
    }
    ...
    public static buildGetGroupDetailReq(groupId: Long): WLBuildMsgRet {
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_GROUP, WL.Group.GroupCommandId.GROUP_COMMAND_GET_GROUPDETAIL,
            WL.Service.CommandType.COMMAND_REQUEST, groupMessage);
    }
    ...
    public static buildGetSubDeviceGroupAttributes(subUserId: number): WLBuildMsgRet {
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_GROUP, WL.Group.GroupCommandId.GROUP_COMMAND_GET_SUB_GROUPATTRIBUTE,
            WL.Service.CommandType.COMMAND_REQUEST, groupMessage, subUserId);
    }
    ...
    public static buildAddSubMemberReq(groupId: Long, userIds: number[]): WLBuildMsgRet {
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_GROUP, WL.Group.GroupCommandId.GROUP_COMMAND_ADD_SUB_MEMBER,
            WL.Service.CommandType.COMMAND_REQUEST, groupMessage);
    }
}
