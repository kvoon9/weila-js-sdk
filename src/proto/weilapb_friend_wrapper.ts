...
class WeilaPbFriendWrapper {
    public static buildGetFriendInfoReq(latestUpdated: Long): WLBuildMsgRet {
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_FRIEND, WL.Friend.FriendCommandId.FRIEND_COMMAND_GET_FRIENDINFO,
            WL.Service.CommandType.COMMAND_REQUEST, friendMessage);
    }
    ...
    public static buildGetFriendUserInfoReq(userIdList: number[]): WLBuildMsgRet {
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_FRIEND, WL.Friend.FriendCommandId.FRIEND_COMMAND_GET_FRIEND_USERINFO,
            WL.Service.CommandType.COMMAND_REQUEST, friendMessage);
    }
    ...
    public static buildGetFriendInvitationInfoReq(latestUpdated: Long): WLBuildMsgRet {
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_FRIEND, WL.Friend.FriendCommandId.FRIEND_COMMAND_GET_FRIEND_INVITEINFO,
            WL.Service.CommandType.COMMAND_REQUEST, friendMessage);
    }

    public static buildFriendInviteReq(inviteeId: number, detail: string, remark: string, subUserId?: number): WLBuildMsgRet {
        const friendMessage = new WL.Friend.FriendMessage();
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_FRIEND, WL.Friend.FriendCommandId.FRIEND_COMMAND_FRIEND_INVITE,
            WL.Service.CommandType.COMMAND_REQUEST, friendMessage, subUserId);
    }

    public static buildAnswerFriendInviteReq(inviterId: number, status: number, remark: string): WLBuildMsgRet {
        const friendMessage = new WL.Friend.FriendMessage();
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_FRIEND, WL.Friend.FriendCommandId.FRIEND_COMMAND_ANSWER_FRIEND_INVITE,
            WL.Service.CommandType.COMMAND_REQUEST, friendMessage);
    }
    ...
    public static buildDeleteFriendReq(userId: number, subUserId?: number): WLBuildMsgRet {
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_FRIEND, WL.Friend.FriendCommandId.FRIEND_COMMAND_DELETE_FRIEND,
            WL.Service.CommandType.COMMAND_REQUEST, friendMessage, subUserId);
    }

    public static buildChangeFriendInfoReq(userId: number, changeFriendInfo: WLChangeFriendInfo): WLBuildMsgRet {
        const friendMessage = new WL.Friend.FriendMessage();
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_FRIEND, WL.Friend.FriendCommandId.FRIEND_COMMAND_CHANGE_FRIENDINFO,
            WL.Service.CommandType.COMMAND_REQUEST, friendMessage);
    }
    ...
    public static buildGetFriendBlacklistReq(pageIndex: number, pageCount: number): WLBuildMsgRet {
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_FRIEND, WL.Friend.FriendCommandId.FRIEND_COMMAND_GET_BLACKLIST,
            WL.Service.CommandType.COMMAND_REQUEST, friendMessage);
    }

    public static buildChangeFriendBlacklistReq(userIdList: number[], actionType: number): WLBuildMsgRet {
        const friendMessage = new WL.Friend.FriendMessage();
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_FRIEND, WL.Friend.FriendCommandId.FRIEND_COMMAND_CHANGE_BLACKLIST,
            WL.Service.CommandType.COMMAND_REQUEST, friendMessage);
    }
    ...
    public static buildGetOnlineFriendsReq(): WLBuildMsgRet {
        ...
        return BuildWeilaMsg.buildWeilaMsgReq(WL.Service.ServiceID.SERVICE_FRIEND, WL.Friend.FriendCommandId.FRIEND_COMMAND_GET_ONLINE_FRIEND,
            WL.Service.CommandType.COMMAND_REQUEST, friendMessage);
    }
