...
module.exports = (env) => {
    return {
        ...
        output: {
            path: process.env.NODE_ENV === 'production' ? path.resolve(__dirname, 'dist') : path.resolve(__dirname, '../../project_dir/weila_webapp/node_modules/weilasdk/dist'),
                    ...
                    use: [{
                        ...
                        options: {
                            compilerOptions: {
                                ...
                                outDir: process.env.NODE_ENV === 'production' ? path.resolve(__dirname, 'dist') : path.resolve(__dirname, '../../project_dir/weila_webapp/node_modules/weilasdk/dist')
